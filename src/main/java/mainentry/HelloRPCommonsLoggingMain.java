...
import hellorpc.annotation.HelloRPCommonsLoggingCommentItem;
import hellorpc.annotation.HelloRPCommonsLoggingComments;
 ...
 * @since 2015-07-07
 */
@HelloRPCommonsLoggingComments({
        @HelloRPCommonsLoggingCommentItem(dateTime = "2015-11-16 17:09", version = "v0.0.1", notes = {"创建本项目，完成通讯协议设计，完成报文格式解析相关工具类的开发。"})
})
public class HelloRPCommonsLoggingMain {

    public static final String VERSION = "v0.0.1";
    public static final String UPDATE_DATE_TIME = "2015-11-16 17:09";

    public HelloRPCommonsLoggingMain() {
    }
    ...
    public static void main(String[] args) {
        ...
        JLabel topLabel = new JLabel("你好远程过程调用框架日志代理之Slf4j " + getVersion());
...
//        mainScrollPane.setViewportView(changeLogArea);
        ...
        mainFrame.add(new HelloRPCommonsLoggingChangeLogPanel(HelloRPCommonsLoggingMain.class), java.awt.BorderLayout.CENTER);
