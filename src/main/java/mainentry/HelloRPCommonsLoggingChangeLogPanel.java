 ...
 */
public class HelloRPCommonsLoggingChangeLogPanel extends javax.swing.JPanel {

    private Class<?> clazz;

    /** Creates new form ChangeLogPanel */
    public HelloRPCommonsLoggingChangeLogPanel(Class<?> clazz) {
        this.clazz = clazz;
        initComponents();
        initTable();
    }
    ...
    public DefaultTableModel getTableModel() {
        ...
        HelloRPCommonsLoggingComments commentsAnnotation = clazz.getAnnotation(HelloRPCommonsLoggingComments.class);
        if (commentsAnnotation != null) {
            HelloRPCommonsLoggingCommentItem[] commentItems = commentsAnnotation.value();
            if (commentItems != null) {
                for (HelloRPCommonsLoggingCommentItem item : commentItems) {
